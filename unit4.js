...
5. FAIL (Знаки припинания - не слова! Ошибка подсчета на такой строке. "Строка      из русских слов что-то про ... Эммм чай ? ")
6. PASS
7. FAIL (Не проходит решение на смещении 1 !! Нужно доработать)
